...
- 文风基准是「金庸腔」：短句、白描、少形容词；样本见 `planning/wayfinder-content-rewrite/prototypes/worldview-seed-v3.md` 第 10 节。内容按**单场景增量**推进：每轮只起草或修改一个场景；用户确认并落库试玩后，才进入下一场景。禁止批量生成或提前写入后续场景。
